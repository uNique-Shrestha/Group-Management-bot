...
def gban(bot: Bot, update: Update, args: List[str]):
    ...
    if not user_id:
        message.reply_text("Gay, you don't seem to be referring to a user.")
        return
    ...
    if user_id == bot.id:
        message.reply_text("-_- So funny, lets gban myself why don't I? Nice try, *me grabs a popcorn*")
        return
    ...
    message.reply_text("Okey wait sar im banning that noob globally.")
    ...
    for chat in chats:
        ...
        try:
            ...
            if excp.message in GBAN_ERRORS:
                ...
                message.reply_text("Ufff! could not gban due to: {}".format(excp.message))
                send_to_list(bot, SUDO_USERS + SUPPORT_USERS, "Ufff! could not gban due to: {}".format(excp.message))
    ...
    send_to_list(bot, SUDO_USERS + SUPPORT_USERS, 
                ...
                html=True)
    message.reply_text("Hahaha that noob is gbanned now.")
    ...
    for chat in chats:
        ...
        try:
            ...
            if excp.message in UNGBAN_ERRORS:
                ...
                message.reply_text("Sed, could not un-gban due to: {}".format(excp.message))
                bot.send_message(OWNER_ID, "Sed, could not un-gban due to: {}".format(excp.message))
                return
        except TelegramError:
            pass
...
def gbanlist(bot: Bot, update: Update):
    ...
    if not banned_users:
        update.effective_message.reply_text("There aren't any gbanned users! You're kinder than I expected sar...")
        return
